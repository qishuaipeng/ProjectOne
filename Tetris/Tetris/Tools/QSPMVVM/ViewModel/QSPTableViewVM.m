...
- (QSPTableViewSectionVM *)sectionVMWithSection:(NSInteger)section {
    return [self.sectionVMs objectAtIndex:section];
}
- (QSPTableViewCellVM *)rowVMWithIndexPath:(NSIndexPath *)indexPath {
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return [self sectionVMWithSection:section].rowCount;
}
